            ...
            <div className="projects-container">
                <article className="project p-1">
                    ...
                    <div className='project-details'>
                        ...
                        <p className="project-about">This is a MERN stack project called THRIVNEST and frontend deployed using Netlify, backend hosted using Render.</p>
                ...
                <article className="project p-2">
                    <div className='project-details'>
                        ...
                        <p className="project-about">This project is built using React and a to-do lists are stored in local storage. It is deployed using Netlify.</p>
                        <div className="projects-btn">
